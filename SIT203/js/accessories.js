		...
		function FilterBasedOnCatergory() 
		{
			...
			var catergories = ["HOMEDECO", "RUG", "LIGHTING", "PLANTSTAND"];
			var ITEMNAME = 1;			
			var ITEMPRICE = 3;
			var ITEMDETAILS = 5;
			var ITEMMATERIALS = 7;
			...
			// FILTERBY used to determine catergory selection. 'ACCESSORIES', special case. Needs to show all furniture
		...
		{			
			...
			if (urlSplit.length == 2) 
				...
				FILTERBY = 'ACCESSORIES';		// Otherwise display all items.
				
			// Update box catergory heading to refelect selections.
			switch (FILTERBY) 
			{
				case "HOMEDECO"   : document.getElementById("TitleBox").innerHTML = "Home Deco"; break;
				case "RUG"        : document.getElementById("TitleBox").innerHTML = "Textiles & Rugs"; break;
				case "LIGHTING"	  : document.getElementById("TitleBox").innerHTML = "Lighting"; break;
				case "PLANTSTAND" : document.getElementById("TitleBox").innerHTML = "Plant Pots & Stands"; break;
				default		      : document.getElementById("TitleBox").innerHTML = "All Accessories";
			}
